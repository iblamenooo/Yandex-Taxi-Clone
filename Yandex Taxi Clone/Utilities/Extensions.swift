...
extension UIView {
    ...
    func containterInputView(image:UIImage, textField:UITextField? = nil, segmentedControl: UISegmentedControl? = nil) -> UIView {
        ...
        let imageView = UIImageView() //иконка
        imageView.image = image
        imageView.alpha = 0.87 //альфа делает иконку слегка прозрачной
    ...
    //custom Auto Layout helper
    func anchor(top:NSLayoutYAxisAnchor? = nil, //вместо долгого NSLayout.constraint можно просто написать view.anchor() это енкапсуляция layout logic
